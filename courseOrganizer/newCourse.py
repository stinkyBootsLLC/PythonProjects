...
courseWeeks = input("Enter Course Weeks (i.e. 8 or 12)")
...
for i in range(int(courseWeeks)):
    ...
    open(dissDoc, "w")
    # go into the assigment folder
    os.chdir("{}/{}/ASSIGNMENTS".format(course_root_folder,week))
    assignDoc = "assignment_{}.docx".format(i + 1)
    # create a word file in the assigment folder
    open(assignDoc, "w")
